...
contract PropertyRent {
    ...
    // function addPropertyAgreement(uint propertyId,uint start, uint end, address payable ownerWalletAddress, address payable tenantWalletAddress) public{
    ...
    //     owners[walletAddress].due = fiveMinuteIncrements * 5000000000000000;
    // }

    // Deposit money to owners wallet
    // function deposit(address walletAddress) payable public{
    //     owners[walletAddress].balance += msg.value;
    // }
    ...
    function makePayment(address tenantWalletAddress, address ownerWalletAddress) public payable{
        // require(owners[walletAddress].due > 0 , "You dont have due amount");
        // require(owners[walletAddress].balance > msg.value , "You dont have due amount");
        setRentalPoints(tenantWalletAddress);
        owners[ownerWalletAddress].balance  +=  100;
        // owners[walletAddress].balance -= msg.value;
        // owners[walletAddress].canRent = true;
        // owners[walletAddress].due = 0;
        // owners[walletAddress].start = 0;
        // owners[walletAddress].end = 0;
    }
}